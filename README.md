...
## This is a fork of MiniCore, to prevent setting the incorrect clock frequency on DIGIduino boards, I have removed any unnecessary chip and clock options [colour:red]. 
